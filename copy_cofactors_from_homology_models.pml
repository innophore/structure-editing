"""This script takes homology models and AI-predicted modles with similar sequences and copies fitting ligands from the homology model into the AI-predicted model."""
...
os.mkdir(problematic_output_dir)
